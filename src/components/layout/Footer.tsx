...
const Footer = () => {
  return (
    <footer className="bg-health-neutral-50 border-t">
      <div className="health-container py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="mt-4 text-health-neutral-600">
              Bringing quality healthcare to underserved and rural populations through innovative technology.
            </p>
          </div>
          
          <div>
            <h5 className="font-semibold text-health-neutral-800 mb-4">Company</h5>
        ...
        <div className="mt-12 pt-8 border-t border-health-neutral-200">
          <div className="flex flex-col md:flex-row md:justify-between items-center">
            <p className="text-health-neutral-500 text-sm">
              © {new Date().getFullYear()} LifeSage Health. All rights reserved.
            </p>
            <div className="mt-4 md:mt-0 flex space-x-6">
              <a href="#" className="text-health-neutral-500 hover:text-health-blue-500">
